...
namespace ModelsTest.Models_Test.Web_Test.Parsers_Tests
{
    ...
    public class FilmsPreviewLordfilmParserTests
    {
        ...
        public async Task Get_5_bing_film_contains_site_name()
        {
            ...
            var filmsName = await new FilmsPreviewLordfilmParser().GetFilms(siteHtml).Take(5).ToListAsync();
        ...
        public async Task Get_All_bing_film_contains_site_name()
        {
            ...
            var filmsName = await new FilmsPreviewLordfilmParser().GetFilms(siteHtml).ToListAsync();
